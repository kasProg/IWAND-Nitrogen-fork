...
# Path to all gauges/ csv files for different HUCs. (An example dataset can be found in the project folder /Scripts/Watershed_Boundary_Extraction/data/HUC02/csv"
