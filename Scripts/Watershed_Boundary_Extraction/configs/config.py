...
catchment_path      = r"path to NHDPlusCatchment shapefiles for all HUCs from NHDPlus"# https://www.epa.gov/waterdata/get-nhdplus-national-hydrography-dataset-plus-data#Download
